...
function fizzBuzz(numero) {
  ...
  let chain = '';
  if (numero % 3 === 0) chain = 'fizz';
  if (numero % 5 === 0) chain += 'buzz';
  return chain === '' ? numero : chain;
}
...
function esPrimo(numero) {
  ...
  for (let i = 3; i < Math.floor(numero / 2); i += 2)
...
function tieneTresDigitos(numero) {
  ...
  //Escribe tu código aquí
  const chain = numero.toString();
  return chain.length === 3 ? true : false;
}
